          ...
          <div className="grid grid-cols-1 items-start gap-8 xl:grid-cols-[minmax(0,420px)_minmax(0,1fr)] xl:gap-10">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-3 rounded-3xl border border-gray-200 bg-white p-4 shadow-lg shadow-gray-100 sm:grid-cols-2 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
                ...
                {product.promotionId && (
                  <button
                    onClick={() => window.open(`https://buyin.jinritemai.com/dashboard/merch-picking-library/merch-promoting?id=${product.promotionId}`, '_blank')}
                    className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-500 to-purple-600 px-6 py-3.5 font-medium text-white shadow-lg shadow-violet-500/30 transition-all duration-300 hover:from-violet-400 hover:to-purple-500 hover:shadow-violet-500/50 group active:scale-[0.98]"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
